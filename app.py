...
col1_price = (col1_df.weightedAvgPrice)
col2_price = (col2_df.weightedAvgPrice)
col3_price = (col3_df.weightedAvgPrice)
col4_price = (col4_df.weightedAvgPrice)
col5_price = (col5_df.weightedAvgPrice)
col6_price = (col6_df.weightedAvgPrice)
col7_price = (col7_df.weightedAvgPrice)
col8_price = (col8_df.weightedAvgPrice)
col9_price = (col9_df.weightedAvgPrice)
